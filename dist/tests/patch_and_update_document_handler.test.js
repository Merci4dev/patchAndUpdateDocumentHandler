...
const patch_and_update_document_handler_1 = require("../src/patch_and_update_document_handler");
...
describe('patchAndUpdateDocumentHandler', () => {
    ...
    test('should update the value of an existing field', () => {
        ...
        const updatedDoc = (0, patch_and_update_document_handler_1.patchAndUpdateDocumentHandler)(originalDoc, update);
    ...
    test('should handle non-array when expecting an array', () => {
        ...
        const result = (0, patch_and_update_document_handler_1.patchAndUpdateDocumentHandler)(originalDocument, update);
    ...
    test('should apply an update to change array value by _id', () => {
        ...
        // Apply the update
        const updatedDocument = (0, patch_and_update_document_handler_1.patchAndUpdateDocumentHandler)(document, update);
        // Verify the update was applied correctly
        expect(updatedDocument).toBeDefined();
        expect(updatedDocument.a).toBeDefined();
        expect((_a = updatedDocument.a) === null || _a === void 0 ? void 0 : _a.b).toBeDefined();
        expect((_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.b[0]._id).toBe('5dc0ad700000000000000000');
        expect((_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b[0].titleValue).toBe('asdf1-updated');
        expect((_d = updatedDocument.a) === null || _d === void 0 ? void 0 : _d.b[0].name).toBe('asdf1'); // Make sure other values remain the same
    ...
    test('should add a new entry to an array', () => {
        ...
        expect(updatedDocument.a).toBeDefined();
        expect((_a = updatedDocument.a) === null || _a === void 0 ? void 0 : _a.b).toBeDefined();
        const newItemIndex = (_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.b.findIndex((item) => item._id === '5dc0ad700000000000000003');
        expect(newItemIndex).toBeGreaterThan(-1); // New item should exist
        const newItem = (_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b[newItemIndex];
        expect(newItem).toBeDefined();
        expect(newItem === null || newItem === void 0 ? void 0 : newItem._id).toBe('5dc0ad700000000000000003');
        expect(newItem === null || newItem === void 0 ? void 0 : newItem.name).toBe('co2'); // Verify new item's name
        expect(updatedDocument.value).toBe('hui'); // Make sure other properties are not affected
    });
    test('should remove an array entry by _id', () => {
        ...
        const removedItemIndex = (_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.b.findIndex((item) => item._id === '5dc0ad700000000000000001');
        expect(removedItemIndex).toBe(-1); // Entry should not be found
        // Verify the length of the array to ensure an entry was removed
        expect((_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b.length).toBe(2);
        // Check that the remaining entries are as expected
        expect((_d = updatedDocument.a) === null || _d === void 0 ? void 0 : _d.b[0]._id).toBe('5dc0ad700000000000000000');
        expect((_e = updatedDocument.a) === null || _e === void 0 ? void 0 : _e.b[1]._id).toBe('5dc0ad700000000000000002');
    ...
    test('should add a regular object value', () => {
        ...
        expect(updatedDocument.a).toBeDefined();
        expect((_a = updatedDocument.a) === null || _a === void 0 ? void 0 : _a.c).toBeDefined();
        // Assert that the value of property 'c' is 'hallo'
        expect((_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.c).toBe('hallo');
        // Verify that the array 'b' is still intact
        expect((_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b.length).toBe(3);
        expect((_d = updatedDocument.a) === null || _d === void 0 ? void 0 : _d.b[0].name).toBe('asdf1');
        expect((_e = updatedDocument.a) === null || _e === void 0 ? void 0 : _e.b[1].name).toBe('asdf2');
        expect((_f = updatedDocument.a) === null || _f === void 0 ? void 0 : _f.b[2].name).toBe('asdf3');
    ...
    test('should update a regular object value', () => {
        ...
        expect((_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.c).toBe('hallo-changed');
        // Verify that the array 'b' is still intact
        expect((_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b.length).toBe(3);
        expect((_d = updatedDocument.a) === null || _d === void 0 ? void 0 : _d.b[0].name).toBe('asdf1');
        expect((_e = updatedDocument.a) === null || _e === void 0 ? void 0 : _e.b[1].name).toBe('asdf2');
    ...
    test('should unset a regular object value on root level', () => {
        ...
        expect(updatedDocument.a).toBeDefined();
        expect((_a = updatedDocument.a) === null || _a === void 0 ? void 0 : _a.b.length).toBe(3);
        expect((_b = updatedDocument.a) === null || _b === void 0 ? void 0 : _b.b[0]._id).toBe('5dc0ad700000000000000000');
        expect((_c = updatedDocument.a) === null || _c === void 0 ? void 0 : _c.b[1]._id).toBe('5dc0ad700000000000000001');
        expect((_d = updatedDocument.a) === null || _d === void 0 ? void 0 : _d.b[2]._id).toBe('5dc0ad700000000000000002');
    });
    ...
    test('should apply user image update', () => {
        ...
        // Apply the update to the document
        const updatedObj = (0, patch_and_update_document_handler_1.patchAndUpdateDocumentHandler)(obj, update);
